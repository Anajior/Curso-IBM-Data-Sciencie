...
app.layout = html.Div([
    html.H1("Automobile Statistics Dashboard",
                                       style={'textAling': 'center', 'color':'#503D36',
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        average_sales = recession_data.groupby('Month')['Automobile_Sales'].mean().reset_index() 
        figure=px.bar(mas,
        x='Month',
        y='Automobile_Sales',
        title="Total Monthly Automobile_Sales")
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        x='year',
        y='Automobile_Sales',
        title='Annual Average Automobile Sales'
        ))
